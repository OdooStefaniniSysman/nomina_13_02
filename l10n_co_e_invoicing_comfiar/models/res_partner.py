...
class ResPartner(models.Model):
	...
	check_mail_einv = fields.Boolean(string='Need attachments in e-invoicing mail', default=False, company_dependent=True,
	...
	rol_pa = fields.Char(string='Rol patrimonio autónomo', company_dependent=True)
	inv_without_decimal = fields.Boolean(string='Invoice without decimals', default=False)
