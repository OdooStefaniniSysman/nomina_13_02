...
class ResCompany(models.Model):
    ...
    effective_delivery_day = fields.Integer(string='Días fecha entrega', help='Este campo representa los días respecto a la fecha de creación de la factura para determinar la fecha efectiva de entrega de los bienes')
