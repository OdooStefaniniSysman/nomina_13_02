odoo.define('ks_dashboard_ninja_list.ks_dashboard_graph_preview', function (require) {
    ...
    var KsGraphPreview = AbstractField.extend({
        ...
        init: function (parent, state, params) {
            ...
            this.jsLibs.push('/ks_dashboard_ninja/static/lib/js/Chart.js',
            ...
            this.cssLibs.push('/ks_dashboard_ninja/static/lib/css/Chart.css',
        ...
        _render: function () {
            this.$el.empty()
             if (this.recordData.ks_dashboard_item_type !== 'ks_tile' && this.recordData.ks_dashboard_item_type !== 'ks_list_view') {
        ...
        _getChartData: function () {
            ...
            //FIXME : Right now its just a duckPatch. Fix this async call later
            //Problem : Cannot render chart when element is not inserted in DOM
            this._rpc({
                model: 'ks_dashboard_ninja.item',
                method: 'ks_chart_load',
                args: [],
            }).then(function (data) {
                var self = this;
                var $chartContainer = $.find('#ksMyChart');
                this.ksMyChart = new Chart($chartContainer[0], {
