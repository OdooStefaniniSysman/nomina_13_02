...
class ResPartnerComercial(models.Model):
    _name = 'res.partner.salesperson'
    _description = 'Res Partner Sales Person'
    ...
    _sql_constraints = [
        ('email_unique',
         'UNIQUE(company_id,partner_id,user_id)',
         "The sales person must be unique per partner and company"),
    ]
