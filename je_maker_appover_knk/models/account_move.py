...
class AccountMove(models.Model):
    ...
    def post(self):
        ...
        if not self.env.user.has_group('je_maker_appover_knk.approver_user'):
    ...
    def button_confirm(self):
        self.write({'state': 'ready_to_post'})

    def button_reset_to_post(self):
        self.write({'state': 'ready_to_post'})
